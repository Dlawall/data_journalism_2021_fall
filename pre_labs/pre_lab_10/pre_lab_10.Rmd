...
**Answer** https://datawrapper.dwcdn.net/4AfIX/1/
...
**Answer** The code is assigning a name to the dataset and grouping by project_county_name, then counting the values for each county.
...
**Answer** This code is taking the previous codeblock and filtering the count variables for only those greater than six.
...
**Answer** The codes have all been printed as five digit codes. 
...
**Answer** I see a joined dataset that counties with their loan counts and state and county codes.
...
**Answer** The new map now only shows the counties in Maryland that we are looking for. 
...
**Answer** I am receiving an error when trying to change the count code to the formatted count code.
...
**Answer** https://datawrapper.dwcdn.net/QTq2d/1/
