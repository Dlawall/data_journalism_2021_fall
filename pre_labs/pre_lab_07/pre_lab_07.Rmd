...
**There are multiple spreadsheets displaying information on different industries and their NAICS sectors.**
...
**A breakdown of an html wire frame with drop down menus.**
...
**This codeblock outputs what looks like HTML code.**
...
**There aree changes to the value columns for each HTMl breakdown.**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**I see the HTML code that makes up the webpage.**
...
**The code has split the table up into smaller tables related to the data on the webpage.**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**The naics_industry environment has adjusted to include the information we just pulled from the webpage.**
...
**The specific information from the dataset is in those drop down menus, separated by columns.**
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**This new table is essentially the table from the webpage in the same format.**
...
**A list of sectors and their corresponding descriptions per NAICS codes.**
...
**This output is the same as the previous output, but with the two variables side by side instead of being on separate pages.**
...
**A table with side by side sectors and descriptions of those sectors.**
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**This webpage shows job data broken down by fiscal quarters, years and months.**
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**An HTML codeblock that makes up the webpage.**
...
**An increased scope of the HTML in the webpage, with more HTML components included.**
...
**A table showing employment information broken down by months.**
...
**Only the June 2021 portion of the data in the previous table is included.**
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Employment info from 2021 broken down by different time frames for the Oil industry.**
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**The same information for the Construction industry.**
...
**A list of the same sectors provided in the codeblock.**
```{r}
...
**A list of the sectors printed as a result of the for loop in the code.**
```{r}
...
**There is an error saying the list referenced in teh code is not found.**
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**A printed list of the sectors in the code.**
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**An error stating that the sector requested in the code is not found.**
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**A printed list of numbers as a result of the code.**
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**NAICS sectors with their corresponding descriptions in a table.**
...
**The number 20 appears, referenced in the row it was chosen in **
...
**The code printed a list of numbers 1-20.**
...
**The code printed the sector employment for June 2021.**
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**The code printed the sectors and descriptions for the employment data.**
```{r}
# Define url of page we want to scrape
...
**The table pulls the urls and lists them in respect to the industry they are connected to.**
...
**This table does the same as the previous table but includes the sector code in the xpath column.**
...
**This table shows the sectors, description, url and xpath.**
...
**This code displays the informaiton for each sector and splits them up into individual tables.**
...
**This code prints the same information from the previous table but lists it out in the output instead of splitting it into tables.**
```{r}
...
**This code prints the data from each individual sheet on the webpage with the information in tables.**
...
**This code runs the data from monthly employment by month.**
...
**This code prints the sector information along with the yearly employment date, as well as the URL.**
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**This table simply prints monthly employment info for each sector.**
...
**This code compiles the information from the previous codeblock and puts it all into one table.**
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**This webpage shows employment data by month for 2021.**
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**This shows employment for the Argiculture industry.**
...
**This codeblock shows each sector, description, and June 2021 employment information.**
