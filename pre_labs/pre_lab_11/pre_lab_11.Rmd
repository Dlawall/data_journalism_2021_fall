...
**A shape file split into different components.**
...
**The data is laid out for me, broken down by column and data type. Column names span from names of hospitals to their geo-coordinates.**
...
**This data is now organized by column name and filtered to only Maryland.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**General acute care hospitals are overwhelmingly common, while all other types of hospitals are relatively rare.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The data has now been filtered to show only general acute care hospitals.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The points from the previous code have been plotted on a lat-long chart.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Tigris has been installed, with some extra instructions if we would like to cache our data.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Data points are listed by column head and broken down by data type.**
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**AThe data has been moved into a separate sheet and filtered down to STATEFP 24.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**There is now an outline of Maryland on a lat and long plot.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The map above and the data points from earlier have been combined to show a complete plotted map.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The map now shows color coded dots that indicate the frequency of beds in these hospitals.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Data showing acute care hospitals in Maryland is displayed, broken down by column head.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The data from above is now broken down by county.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Each county in Maryland has been broken down by population variable. **
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Latitude and longitude coordinates have been pulled down for these counties. **
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The amount of beds per county is listed. **
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**AFoundation for shaping has been loaded in, with multipolygon and geometry information put in.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The same information as above has been put in, except this block is used for the amount of beds found in each county.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**The previous two datasets have been combined.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**This dataset takes the previous two and adds another column (beds per 100k).**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**A full outlined map of Maryland is color coded by county for beds per 100k.**
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**AThe color palate has been changed to make different counties stand out more. **
...
**Decimals have been added to the number values in teh key and the color scheme was altered slightly. **
