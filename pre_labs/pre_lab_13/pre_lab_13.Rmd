...
**This code outputs states with their percent of votes in the 2016 election for Trump with ppp statistics for each of those states.**
```{r}
...
**This code prints a plot showing the relationship between the percentage of businesses that received ppe and their state's percentage of votes for Trump.**
```{r}
...
### Task 4: Plot data
**Task** Run the following code. Describe the plot. What do you see?
**This code shows the relationship between the amount of ppe received per employee and the percentage of votes for Trump.**
```{r}
...
**This table shows the r value of votes for Trump for the percentage of businesses receiving ppe and the ppe amount per the employees of those businesses. **
```{r}
reveal_data %>%
...
**This table outputs different ststistical test values, such as the t value and confidence interval.**
```{r}
...
**Task** Run the following code. Describe the model output. What do you see?
**This code outputs the same statistics for the opposite relationship within the dataset.**
```{r}
...
**This table compares the average ppp amount per employee and the average amount of ppe received per business between those that voted for Trump and Clinton.**
```{r}
reveal_data %>%
  group_by(vote_2016) %>%
  summarise(
...
**This code shows a t test and confidence interval for the two samples above.**
```{r}
...
### Task 10: Run t-test
**Task** Run the following code. Describe the output. What do you see?
**This t test is the same as above except it focuses on the percentage of businesses receiving ppe instead of the percentage of employees receiving ppp.**
```{r}
