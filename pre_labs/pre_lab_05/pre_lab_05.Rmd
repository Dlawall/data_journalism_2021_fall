...
**City names that describe the same city are either misspelled, incorrectly capitalized or a combination of the two.**
...
**Refinr put the city names in sentence case and corrected multi-word city names.**
...
**The refinr function counted the number of instances of each city, put the city names into sentence case (with the exception of a handful of cities, and broke the cities down into groups based on their spelling.**
...
**The changes made are not largely substantial, but there are still changes made, particularly regarding the capitalizaiton of the first letter in each city, which is much more accurate after this code block.**
