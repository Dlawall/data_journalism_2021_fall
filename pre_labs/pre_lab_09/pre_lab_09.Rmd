...
**This dataset has 195,865 rows and 63 columns.**
...
**The code is taking and renaming the dataset, then grouping by the project_county_name variable, counting the total number of loans and sorting that value from greatest to least.**
...
**This code produces a plain plot that will house our plot going forward.**
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**The plot houses a bar chart with the information from the dataset sorted by county.**
...
**The data is now sorted from least to greatest by count.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**The graph has now flipped to a horizontal orientation, making the labels easier to read. **
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**The theme has been adjusted to 'minimal'.**
...
**The theme has been further adjusted, this time to match aesthetics from the Economist.**
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**This plot has added a title, a label to the x and y axis and a caption for the entire plot.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**A chronological list of dates approved and the number of loans approved on those days.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**This code draws a line plot illustrating the chronological data from the previous question.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**This plot breaks datapoints down month by month instead of a six month break as seen in the previous plot.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**The labels have had their angles adjusted 45 degrees so that they are more readable.**
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
