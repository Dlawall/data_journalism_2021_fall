...
**The dataframe is a compilation of COVID vaccines and a running tally of those vaccines by date in Anne Arundel County. **
...
**This dataframe lists vaccinations by county, but there is one row listed as 'NA'**
...
**This data represents vaccine totals broken down by daily and cumulative first and second doses.**
...
**Saturdays tend to rank higher than other days of the week.**
...
**Vaccines were more heavily administered last spring and summer and have tapered off since.**
...
**COVID-19 vaccination rates peaked when the vaccine first became available, but have fallen off heavily as more people in Prince George's County became vaccinated.**
...
**This chart shows each Maryland county's total COVID cases in a line chart spanning from early 2020 to today.**
...
**Task** Run the following code and describe what the resulting chart shows
**This chart is similar to the previous one, except cases are tracked logarithmic instead of in a gross total. **
...
**There are 3233 rows in this dataframe.**
...
**There are 24 rows in this dataframe.**
...
**The graph is showing COVID-19 cases in Maryland by county, shaded based on frequency.**
