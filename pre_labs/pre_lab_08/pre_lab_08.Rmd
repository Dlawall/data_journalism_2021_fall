...
```{r echo=FALSE}
census_api_key("50e4de808e19c91a97143de73ea0aee242584dba", install=TRUE)
```
...
**Nevada had the largest percentage growth with a change of +35.1%.**
...
**Howard county has the highest median income with a total of $121,160.**
...
**Yes, because the wide margin of error in Calvert county could place the county either above or below Montgomery county's median depending on how the margin falls.**

Is the difference between Howard and everyone else significant?
**No because the even the lowest estimate for Howard county would still result in the highest median income estimate.**
...
**Somerset and Caroline counties saw their median incomes fall from 2010 to 2019, but the changes were within the margin of error for both.**
...
**Zip codes 21202, 21740 and 21201 have estimated median incomes of less than $50,000.**
