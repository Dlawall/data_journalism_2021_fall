...
A1:The West Virginia cities in Kanawha County with the most loans are Charleston (2837), South Charleston (484), Saint Albans (304) Dunbar (166) and Nitro (142). 
```{r}
...
A2: This zip code is located in Charleston, West Virginia. The business with the largest loan in this zip was Jackson Kelley PLLC, with a loan amount of $5,068,472. The loan was forgiven for $5,126,618.64. The forgiveness was larger than the loam amount, which accounts for interest accrued over the course of the loan.
...
# 3 carol miller partnerships and corps
