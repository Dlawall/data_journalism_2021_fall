...
# Write the code to load the CSV file here
  international_migration <- read_csv("data/tabula-md-statistical-handbook.csv", skip = 2, col_names = c("County","July_2010-2011","July_2011-2012","July_2012-2013","July_2013-2014", "July_2014-2015", "July_2015-2016","July_2016-2017","July_2017-2018","July_2018-2019","Total"))
```
...
**A1** [The suburban Washington region accounted for the largest percentage change overall at 63 percent, while Montgomery County was the county with the largest percentage change at 37%.]
...
**A2** [The data shown in A1 shows that immigrants were far more likely to move into suburban areas in close proximity to Washington D.C. (such as Montgomery County).  ]
...
**A3** [Cecil county had the largest percentage change for international migration between July 2018 and July 2017 at -128 percent.]

```{r}
# Write the code to produce your answer here
international_migration %>%
  mutate(percent_change=(`July_2018-2019`-`July_2017-2018`)/`July_2017-2018`) %>%
  arrange(desc(percent_change))
```

**Q4** What's your best guess as to why these changes occurred, and in those places in particular?
**A4** [President Donald Trump restricted immigration during his term, and conservative areas (like Cecil county) were more likely to enforce strict immigration policies/be unwelcoming to migrants. ]
...
```{r}
# Write the code to load the CSV file here
  domestic_migration <- read_csv("data/tabula-md-statistical-handbook-domestic.csv", skip = 2, col_names = c("County","July_2010-2011","July_2011-2012","July_2012-2013","July_2013-2014", "July_2014-2015", "July_2015-2016","July_2016-2017","July_2017-2018","July_2018-2019","Total"))
```
...
**A5** [Baltimore City saw the largest net decrease in domestic migration overall.]
...
**A6** [There are 18 regions and jurisdictions with net positive migration for 2017-2019.]

```{r}
# Write the code to produce your answer here
domestic_migration %>%
mutate(migration_2017_2019 = `July_2016-2017`+`July_2017-2018`+`July_2018-2019`) %>%
  arrange(desc(migration_2017_2019))
  
```

**Q7** How would you describe this data? Is there a county or region that stands out, and why?
**A7** [I'm surprised most by the smaller counties (by both land area and population) experiencing the largest net gains. Part of me wants to believe that the more popular counties continue to get popular and vice-versa, but this was not the case in this data.]
